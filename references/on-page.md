...
| Item | Regra |
|---|---|
| Comprimento | **~50–60 caracteres**, alvo **≤ ~600px** (o Google trunca por pixel, não por char) |
| Posição da keyword | Primária nos primeiros ~30 caracteres |
| Marca | Sufixo `| Marca`, ~10–13 chars reservados |
...
**SHOULD**
- Bloco de FAQ com `FAQPage` JSON-LD quando houver perguntas legítimas (`dados-estruturados.md`).
